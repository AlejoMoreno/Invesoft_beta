...
$conexion= conexion();
$bill_remision = mysqli_query($conexion,"SELECT * FROM  `remision` WHERE `documento` LIKE 'R%' ORDER BY  `remision`.`fecha` ASC ") or die(mysqli_error($conexion));
