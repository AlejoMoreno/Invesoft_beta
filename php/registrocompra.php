...
$bill_cliente = mysqli_query($conexion,"SELECT * FROM  `terceros` where `tipo` like 'PROVEEDOR'") or die(mysqli_error($conexion));         
...
<br>
<center><h2>FACTURA COMPRA C</h2></center><hr>
<table class="tg">
  <tr>
    <th class="tg-031e" colspan="5">
		<div id="numeroremision"><label>NÚMERO DE FACTURA: </label><input type="text" name="idremision" id="idremision" ></div>
    </th>
  </tr>
  <tr>
    <td class="tg-le8v" colspan="2">PROVEEDOR</td>
...
<table>
	...
	<tr>
		<td colspan="5"><label>Condiciones de esta Remisión</label><br><textarea id="observaciones" placeholder="Escriba las observaciones de este documento"></textarea></td>
	</tr>
</table>
