...
$bill_producto = mysqli_query($conexion,"SELECT * FROM  `inventario` WHERE  `idbodega` = 1 ORDER BY  `inventario`.`descripcion` ASC ") or die(mysqli_error($conexion)); 
...
<table class="tg">
  ...
  <tr>
    <td class="tg-yw4l" colspan="2"><input type="text" name="nit_cliente" id="nit_cliente" onblur="buscarCedula('nit_cliente')" placeholder="nit / cedula ej.(1 030570356)"></td>
    <td class="tg-yw4l" width="20%"><label>VENDED</label><input type="text" name="vendedor" id="vendedor" placeholder="vendedor" value="<?php echo $ns;?>" disabled></td>
  </tr>
